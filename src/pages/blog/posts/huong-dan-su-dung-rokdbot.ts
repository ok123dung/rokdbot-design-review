...
export const post: BlogPost = {
  ...
  readTime: "4 phút",
  content: `
> 📖 **Cập nhật 2026** — gói Premium VIP 3M (3-4 đạo) đã ra. Đọc roadmap chi tiết: [F2P → VIP 2 Trong 45 Ngày Với Bot](/blog/f2p-to-vip2-bot-progression-roadmap-rok-2026) hoặc [So Sánh ROI 5 Gói Cước](/blog/rokdbot-v3-vs-v2-vs-v1-roi-comparison-2026).
